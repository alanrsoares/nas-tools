...
import { readDirectoryWithTypes, logError, validateDirectory, } from "./utils.js";
...
async function buildTree(dirPath, prefix = "", depth = 0, options = {}) {
    ...
    try {
        ...
        for (let i = 0; i < filteredEntries.length; i++) {
            ...
            if (isDirectory) {
                ...
                const childLines = await buildTree(childPath, prefix + nextPrefix, depth + 1, options);
...
async function generateTree(targetPath, options = {}) {
...
const program = new Command("dir-tree")
    ...
    .argument("[path]", "Directory path to display (default: current directory)", ".")
